...
----------------------
1- Générer une liste (url par ligne) que vous mettez  dans un fichier (je nomme ce fichier Site-Forums). 
...
Voici comment je lance le moissonnage :
 ...
 ---------------------------------------------------------------------------------------------------------
 |								  
 |	nohup php vigi4Med_MainScraper.php conigFiles/LeFichierDUSite.ini > nohup/nomduSIte_date 2>&1&	  
 |													  
 --------------------------------------------------------------------------------------------------------
